...
export default function Header1() {
    return (
        <header className="p-5 border-gray-300 sticky">
            <div className="flex justify-between items-center">

                <div className="flex justify-between items-center w-full md:w-[50%] flex-row-reverse md:flex-row">
            ...
            <hr className="hidden sm:block border-t-2 border-gray-400 mt-5" />

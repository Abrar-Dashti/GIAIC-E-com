    ...
    return (
        <div className="font-sans text-gray-700">
            ...
            <div className="flex flex-wrap justify-start sm:justify-center items-center">
                <div>
                <Image src="/PLlisting.jpg" alt="The Dandy chair" width={400} height={400} objectFit="cover" quality={100} />
                </div>
                <div className="p-5 sm:p-16 font-light text-sm font-sans text-gray-700">
                    ...
                    <h3 className="text-[1rem] mb-2 font-normal">
                        Product Description
                    </h3>
                    <h5 className="mb-3 sm:w-[30rem]">
                        A timeless design, with premium materials feature as one of our most popular and iconic piece. The dandy chair is perfect for every stylish living space with beech legs and lambskip leather upholstery.
                    </h5>
                    <ul className="list-disc px-7 mb-7">
                        <li>Premium materials</li>
                        <li>Handmade upholstery</li>
                        <li>Quality timeless classic</li>
                    </ul>

                    <h4 className="text-lg font-normal mb-3">Dimension</h4>
                    <div className="flex justify-between font-normal mb-7">
                    ...
                    <div className="mb-4">
                    <h4 className="md:hidden block text-lg font-normal">Quantity</h4>
                    <div className="sm:w-fit flex flex-col sm:flex-row justify-center items-center sm:items-end gap-8 p-2 w-full">

                    <div className="flex sm:flex-row flex-col items-center justify-center gap-10">
                    <h4 className="hidden md:block text-lg font-normal">Amount</h4>
                    <div className="w-[16rem] sm:w-fit flex items-center justify-center gap-5 p-3 bg-gray-100">
                    <button className="h-7 w-7 hover:bg-gray-500 hover:text-white rounded-full">-</button>
                    <h3>1</h3>
                    <button className="h-7 w-7 hover:bg-gray-500 hover:text-white rounded-full">+</button>
                    </div>
                    </div>
                    <button className="w-full sm:w-32 bg-[#2A254B] p-4 text-white ">Add to cart</button>
            ...
            <div className="mt-5">
                <Products phead="You might also like" ptitle1="The lucy lamp" pprice1="399" ptitle2="Rustic vase set" pprice2="155" ptitle3="The silky vase" pprice3="125" ptitle4="The dandy chair" pprice4="250"/>
            </div>
            ...
            <div className="p-7 flex flex-col justify-center items-start sm:items-center">
